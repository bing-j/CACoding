...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(ViewManagerModel viewManagerModel,
        ...
        try {
            ...
            ClearController clearController = createClearUseCase(clearViewModel, clearDataAccessObject);
    ...
    private static ClearController createClearUseCase(ClearViewModel clearViewModel, ClearUserDataAccessInterface clearDataAccessInterface) throws IOException {
